    ...
    public static Connection getInstance() {
        if (connection == null) {
            try {
                ...
                String jdbcAdditionalParams="useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC&useLegacyDatetimeCode=false&UserSSL=false";
